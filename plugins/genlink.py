...
async def gen_link_s(bot, message):
    ...
    if not replied:
        return await message.reply('<b>[❓ How To Used /link](https://t.me/XStoragePandaWep/8)</b>')
...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("<b>[❓ How To Used /batch ](https://t.me/XStoragePandaWep/9)</b>")
