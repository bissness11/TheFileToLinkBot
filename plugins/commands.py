...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://www.youtube.com/@PandaWep')
            ],[
            ...
            InlineKeyboardButton('😎 ᴀʟʟ ᴄʜᴀɴɴᴀʟ 😎', callback_data='help'),
            InlineKeyboardButton('⭐ ᴠɪᴘ ʙᴏᴛꜱ ⭐', callback_data='about')
        ]]
        ...
        try:
            ...
            g = await msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                         InlineKeyboardButton('🔗Get Link 🔗', callback_data=f'generate_stream_link:{file_id}')
                     ]
                    ]
                )
            )
