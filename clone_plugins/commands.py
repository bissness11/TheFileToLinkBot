...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(f"<b><u>This Movie File/Video will be deleted in <b><u>2 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>forward this File/Video to your Saved Messages and Start Download there</i></b>",quote=True)
            ...
            pass
        return await message.reply('Bot Creator - @PandaWep')
    files = files_[0]
